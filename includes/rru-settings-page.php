...
function WC_RRU_all_settings( $settings, $current_section ) {
	...
	if ( $current_section == 'wcrru' ) {
		...
		$settings_rru[] = array(
			'name'     => __( 'Prevent unregistered users to access WooCommerce content', 'woocommerce-rru' ),
			'desc_tip' => __( 'If this is selected, users will be automatically redirected to registration form and hide all prices shown in e.g. front page', 'woocommerce-rru' ),
